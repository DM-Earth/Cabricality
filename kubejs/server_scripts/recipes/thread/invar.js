onEvent("recipes", event => {
  ...
  //	event.shapeless(CABF("nickel_compound"), [CABF("nickel_ingot"), IV("iron_dust"), IV("iron_dust"), IV("iron_dust"), IV("iron_dust")])

  event.blasting(CABF("invar_compound"), CABF("nickel_compound"))
  let s = CABF("invar_compound")
  ...
  event.recipes.createCompacting("1x " + CABF("dye_entangled_singularity"), [dyes, Item.of(AE2("quantum_entangled_singularity"), 1)])
  ...
  event.recipes.createCrushing([
    ...
    CABF("dye_entangled_singularity")).processingTime(50)
  ...
  event.recipes.createPressing(CABF("radiant_sheet"), CR("refined_radiance"))
  event.recipes.createMechanicalCrafting(CABF("radiant_coil"), ["A"], { A: CABF("radiant_sheet") })

  event.shaped(CABF("chromatic_resonator"), [
    " R ",
    "R S",
    "LS "
  ], {
  ...
  /*	let t = CABF("incomplete_inductive_mechanism")
    event.recipes.createSequencedAssembly([
      CABF("inductive_mechanism"),
    ], CR("precision_mechanism"), [
      event.recipes.createDeploying(t, [t, CABF("radiant_coil")]),
      event.recipes.createDeploying(t, [t, CABF("radiant_coil")]),
      event.recipes.createDeploying(t, [t, CABF("chromatic_resonator")])
    ]).transitionalItem(t)
      .loops(1)
      .id(asIdentifier("inductive_mechanism")	*/
  ...
  invar_machine(IV("sawmill_mk1"), 1, CABF("saw_blade"))
