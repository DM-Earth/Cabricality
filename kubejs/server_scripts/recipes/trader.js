function tradeList() {
	...
	let tl = [
		...
		//		Mining
		["mining", "item", "create", "crushed_iron_ore", 16, 12],
		["mining", "item", "create", "crushed_copper_ore", 16, 14],
		["mining", "item", "create", "crushed_zinc_ore", 16, 14],
		["mining", "item", "create", "crushed_gold_ore", 16, 16],
		...
		["mining", "item", "create", "scoria", 64, 1],
		["mining", "item", "create", "veridium", 16, 1],
		["mining", "item", "create", "ochrum", 16, 1],
		["mining", "item", "create", "crimsite", 16, 1],
		["mining", "item", "create", "asurine", 16, 1],
		...
		["mining", "item", "minecraft", "redstone", 48, 2],
		//      Masonry
		...
		["masonry", "item", "tconstruct", "seared_bricks", 64, 8],
		["masonry", "item", "tconstruct", "scorched_bricks", 64, 12],
