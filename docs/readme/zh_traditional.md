<blockquote>
  <details>
    ...
    <!--Head-->
    &emsp;&ensp;<sub><b>永無止境：重縫</b>支持以下語言。<a href="/docs/add_a_localization.md"><code>↗ 添加一種語言</code></a></sub>
    <br />
    <!--Body-->
    <br />
...
當你登陸月球，也就完成了模組包中的最後一個任務。我們的使命結束了，但屬於你的故事永遠不會結束！**Ad Astra!** 使得探索更多的星球甚至星系成為了可能。享受未知宇宙的恐懼和樂趣吧！如果有你喜歡的星球，你還可以在它的近地軌道上建造空間站，仰望星空！*真是件浪漫的事...*
...
如果你希望寫一些模組包脚本來提升遊戲體驗，**隨時歡迎！**

## 技術支持

**所有的技術細節都可以在此GitHub倉庫中找到。如果你想追蹤日後的開發進度，請 `Watch` 此倉庫。**

此模組包使用 [`packwiz`](https://github.com/packwiz/packwiz) 管理和打包內容，並以 [`Modrinth模組包`](https://docs.modrinth.com/docs/modpacks/format_definition) 格式發布。

### 手動構建

你需要在本地Clone此倉庫，並在根目錄運行以下命令：
