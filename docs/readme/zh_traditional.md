...
**永無止境：重縫是一個以 *機械動力* 為中心的Minecraft綜合包，依賴 *Quilt 1.18.2* 運行。**

在這裡，你可以跟隨任務的指引，通過[機械動力](https://github.com/Fabricators-of-Create/Create)和[工業革命](https://github.com/GabrielOlvH/Industrial-Revolution)模組建造屬於自己的工廠！從山谷中徘徊走向空間站裏遨遊，科技發展的可能性由你决定！

> *此整合包在[機械動力：永無止境](https://github.com/simibubi/Above-and-Beyond)的啟發下，重新設計並實現了全部的遊戲流程。我們歡迎每一個挑戰者，並發自內心地希望你們徜徉在Minecraft的遊戲世界中[^wiki]！*
...
作為科技向綜合包，永無止境：重縫以科技發展作為遊戲主線。在此之外，許多可選的有趣支線內容讓科技樹顯得更加花繁葉茂。

每個任務都經過了精心安排，且大部分都有著豐富的描述。別擔心！只要跟緊了它們，絕不會讓你原地打轉、踟蹰不前！

### 任務指引

在任務左側邊欄中，`縱覽`一定是你最常光顧的地方。在那裡，當前的進度一覽無餘。讓我們跟隨科技發展，不斷解鎖**新的章節**和**里程碑**吧！對於每一個全新的章節來說，你都需要製造一條獨特的生產線，而途中有著無數的冒險正等著你...

當然，任務系統只是一個工具。你的遊玩方式由你自己决定！

### 機械紀元

幾乎所有製造機器所需的原材料都是可以**自動生產**的。為每個機器規劃好空間、平衡耗材與產物或許是件痛苦的事，但畢竟一分錢一分貨，一分耕耘一分收穫。到了驗收的時刻，回頭看看你的駭俗之作吧！你付出的努力會成為一塊塊里程碑，鐫刻著科技發展的磅礴歷史。

### 幻想交易

當你擁有足够的黃銅之後，就能够製造**交易站**了。為這精密的儀器通上電源，聽它轟鳴吧！放入`交易銘牌`和`職業銘牌`後，你就可以用手頭的錢幣交換一些罕見的資料了。當然，你也可以用材料**換回**錢幣！*噢，我的寶物啊！*

當你需要生產`諧振末影`材料的時候，交易系統是必需品。這種异界誕生的怪異材料為什麼會將銀幣融進自身是一個未解之謎...如果那時你還不是一名**煉金術士，**那麼交易就會成為獲取銀幣的唯一方式。

### 混沌煉金

在煉金術士手中，珍稀材料從平平無奇的試劑瓶中破蛹而出。現在，你也可以做到！將原材料磨成粉末，摻進熔融玻璃中，能够方便地生產罐裝試劑。在**煉金催化劑**的作用下攪拌、融合，**點石成金。**這就是魔法！

催化劑並不是什麼可以簡單製造的材料。要製造催化劑，首先你需要構築一個**煉金鐳射器**結構，然後對著一些特定的試劑發射高能射線。運氣好的話，你才能得到一瓶催化劑。 對於每個世界，催化劑配方都是不同的。所以打起精神來，永遠不要放弃嘗試！

### 蒼穹之巔

當你登陸月球，也就完成了綜合包中的最後一個任務。我們的使命結束了，但屬於你的故事永遠不會結束！**Ad Astra!** 使得探索更多的星球甚至星系成為了可能。享受未知宇宙的恐懼和樂趣吧！如果有你中意的星球，你還可以在她的近地軌道上建造空間站，仰望星空！*真是件浪漫的事...*

***深空無人，去銀河系漫遊吧！***

## 優化

我們建議你根據實際情況對遊戲進行適當優化。

**如果你想要更順滑流暢的FPS（幀每秒），**開啟垂直同步也許會有所幫助[^fps]。

[^fps]: 若遊戲鎖在30FPS，則請嘗試關閉垂直同步。

如果你希望寫一些綜合包脚本來提升遊戲體驗，**隨時歡迎！**

## 技術支持

**所有的科技細節都可以在此GitHub倉庫中找到。如果你想追跡日後的開發進度，請 `Watch` 此倉庫。**

此整合包使用 [`packwiz`](https://github.com/packwiz/packwiz) 管理和打包內容，並以 [`Modrinth整合包`](https://docs.modrinth.com/docs/modpacks/format_definition) 格式發布。

### 手動構建

你需要在本地尅隆此倉庫，並在根目錄運行以下命令：
...
> *更多信息請翻閱[packwiz wiki。](https://packwiz.infra.link)*

### 啟動器支持

你可以在任意支持**Modrinth整合包**和**Quilt**的啟動器中安裝並運行這個整合包，如[MultiMC、](https://multimcorg)[Prism Launcher](https://prismlauncher.org)和[Hello Minecraft! Launcher](https://hmcl.huangyuhui.net)[^pcl2]。

[^pcl2]: **注意，[PCL2啟動器](https://github.com/Hex-Dragon/PCL2)不受支持。**
