...
public class CabfCreditsScreen extends Screen {
	...
	public void render(MatrixStack matrixStack, int mouseX, int mouseY, float delta) {
		...
		RenderSystem.setShaderTexture(0, Cabricality.Textures.CABRICALITY_TITLE_TEXTURE.identifier());
		...
		RenderSystem.setShaderTexture(0, Cabricality.Textures.MINECRAFT_SUBTITLE_TEXTURE.identifier());
