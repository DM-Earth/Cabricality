...
public enum OreProcessingEntry {
	IRON(MC.id("iron"), MC.id("iron_ingot"), MC.id("iron_nugget"), MC.id("raw_iron"), CR.id("crushed_raw_iron"),
	...
	GOLD(MC.id("gold"), MC.id("gold_ingot"), MC.id("gold_nugget"), MC.id("raw_gold"), CR.id("crushed_raw_gold"),
	...
	COPPER(MC.id("copper"), MC.id("copper_ingot"), CR.id("copper_nugget"), MC.id("raw_copper"),
			CR.id("crushed_raw_copper"),
			IR.id("copper_dust"), TC.id("molten_copper"), MC.id("copper_ore"), MC.id("deepslate_copper_ore"),
			AD.id("glacio_copper_ore")),
	ZINC(CR.id("zinc"), CR.id("zinc_ingot"), CR.id("zinc_nugget"), CR.id("raw_zinc"), CR.id("crushed_raw_zinc"),
			CABF.id("zinc_dust"), TC.id("molten_zinc"), CR.id("zinc_ore"), CR.id("deepslate_zinc_ore")),
	TIN(IR.id("tin"), IR.id("tin_ingot"), IR.id("tin_nugget"), IR.id("raw_tin"), CR.id("crushed_raw_tin"),
			IR.id("tin_dust"), TC.id("molten_tin"), IR.id("tin_ore"), IR.id("deepslate_tin_ore")),
	LEAD(IR.id("lead"), IR.id("lead_ingot"), IR.id("lead_nugget"), IR.id("raw_lead"), CR.id("crushed_raw_lead"),
			IR.id("lead_dust"), TC.id("molten_lead"), IR.id("lead_ore"), IR.id("deepslate_lead_ore")),
	DESH(AD.id("desh"), AD.id("desh_ingot"), AD.id("desh_nugget"), AD.id("raw_desh"), CABF.id("crushed_raw_desh"),
	...
	NICKEL(CABF.id("nickel"), CABF.id("nickel_ingot"), CABF.id("nickel_nugget"), CABF.id("raw_nickel"),
			CR.id("crushed_raw_nickel"), CABF.id("nickel_dust"), TC.id("molten_nickel"));
