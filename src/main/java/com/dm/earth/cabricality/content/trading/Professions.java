...
public enum Professions {
	...
	MINING(Profession.of("mining", 0x826357, of(CR.id("crushed_raw_iron_ore"), 3, SILVER, 1, 0xe8c8b2),
			of(CR.id("crushed_raw_copper_ore"), 3, SILVER, 1, 0xe77a57),
			of(CR.id("crushed_raw_zinc_ore"), 3, SILVER, 1, 0xbae8c2),
			of(CR.id("crushed_raw_gold_ore"), 3, SILVER, 2, 0xf9e845),
			of(CR.id("crushed_raw_nickel_ore"), 3, SILVER, 1, 0xe0dcab),
			of(CR.id("crushed_raw_lead_ore"), 3, SILVER, 2, 0x535466),
			of(CR.id("crushed_raw_tin_ore"), 3, SILVER, 1, 0xdcdcdc),
			of(CABF.id("crushed_raw_calorite_ore"), 1, SILVER, 5, 0xb22c45),
			of(CABF.id("crushed_raw_ostrum_ore"), 1, SILVER, 4, 0x644a59),
			of(CABF.id("crushed_raw_desh_ore"), 1, SILVER, 2, 0xdfa562),
			of(CABF.id("crushed_raw_cobalt_ore"), 2, SILVER, 3, 0x2a79da),
