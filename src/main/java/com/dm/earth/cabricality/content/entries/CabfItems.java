...
public class CabfItems implements LoadTagsCallback<Item>, ResourceConditionCheckTagCallback<Item> {
	...
	public static final Item NICKEL_NUGGET = registerItemModeled("nickel_nugget",
			new Item(Properties.DEFAULT), ItemModelGenerator.generated("item", "nickel_nugget"));
	// Placeholder
	public static final Item RAW_NICKEL = registerItemModeled("raw_nickel",
			new Item(Properties.DEFAULT), ItemModelGenerator.generated("item", "raw_nickel"));
	...
	public static final Item EARTH_CHARGE = registerItemModeled("earth_charge", new Item(Properties.DEFAULT_QUARTER),
