...
public class FluidRendererRegistry {
	...
	public static void renderFluidInit() {
		...
		renderFluids(CabfFluids.MOLTEN_DESH, CabfFluids.MOLTEN_DESH_FLOWING, CabfFluids.MOLTEN_OSTRUM, CabfFluids.MOLTEN_OSTRUM_FLOWING,
				CabfFluids.MOLTEN_CALORITE, CabfFluids.MOLTEN_CALORITE_FLOWING);
