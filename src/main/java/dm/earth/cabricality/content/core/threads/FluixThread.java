	...
	public void addRecipes(RecipeLoadingEvents.AddRecipesCallback.RecipeHandler handler) {
		handler.register(
				...
				id -> VanillaRecipeBuilders
						...
						.output(CABF.asStack("flash_drive"))
						.build(id, "")
		);
		...
		handler.register(recipeId("crafting", "circuit_scrap"),
				id -> VanillaRecipeBuilders.shapedRecipe(" A ", "ABA", " A ")
						...
						.ingredient('B', TagKey.of(RegistryKeys.ITEM, CABF.id("circuit_press")))
						.output(CABF.asStack(2, "circuit_scrap"))
						.build(id, "")
		);
		...
		handler.register(
				...
				id -> new DeployerApplicationRecipe(new FreePRP(id)
						.setIngredient(
								Ingredient.ofItems(AE2.asItem("silicon")),
		...
		handler.register(
				...
				id -> new CrushingRecipe(new FreePRP(id)
						.setIngredient(CABF.asIngredient("blizz_cube"))
						.setResult(
								CABF.asProcessingOutput(1, 2, "blizz_powder"),
		...
		handler.register(
				...
				id -> new CrushingRecipe(new FreePRP(id)
						.setIngredient(CABF.asIngredient("basalz_shard"))
						.setResult(

								CABF.asProcessingOutput(1, 2, "basalz_powder"),
		...
		handler.register(
				...
				id -> new FillingRecipe(new FreePRP(id)
						.setIngredient(Ingredient.ofTag(ItemTags.COALS))
						.setFluidIngredient(FluidIngredient.fromFluid(CabfFluids.COKE, FluidConstants.BOTTLE))
		...
		handler.register(
				...
				id -> new CompactingRecipe(new FreePRP(id)
						.setIngredient(
								CABF.asIngredient("purified_sand"),
								CABF.asIngredient("coke_chunk")
						)
						.setFluidIngredient(
								FluidIngredient.fromFluid(CabfFluids.FINE_SAND,
		...
		handler.register(
				...
				id -> new MixingRecipe(new FreePRP(id)
						.setIngredient(
								CABF.asIngredient("rough_sand"),
								CABF.asIngredient("earth_charge")
						)
		...
		handler.register(
				...
				id -> new MixingRecipe(new FreePRP(id)
						.setIngredient(
								CABF.asIngredient("silicon_compound"),
								CABF.asIngredient("ice_charge"))
		...
		handler.register(
				...
				id -> new FluidInfuserRecipe(id,
						ArrayUtil.of(new InputEntry(MC.asIngredient("ice"), 0)),
						...
						ArrayUtil.<ResourceAmount<FluidVariant>>of(),
						120)
		);
	}
